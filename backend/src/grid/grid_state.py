...
class GridState(object):
    ...
    def __init__(self, case, non_degraded_power, available_power,
                    power_generation, state_of_charge, diesel_consumption, diesel_is_wet_stacking):
        ...
        power_generation        dictionary mapping components to power generated
        state_of_charge         state of charge of aggregate BESS capacity
        diesel_consumption      diesel fuel consumed
        diesel_is_wet_stacking  boolean indicating whether diesel generator is wet stacking
        """
        self._case = case
        ...
        self._diesel_consumption = diesel_consumption
        self._diesel_is_wet_stacking = diesel_is_wet_stacking
    ...
    def diesel_consumption(self):
        return self._diesel_consumption

    def diesel_is_wet_stacking(self):
        return self._diesel_is_wet_stacking
    ...
    def power_supply(self):
        ...
        power_supply = 0.0
        for power in self._power_generation.values():
            power_supply += power
        return power_supply
