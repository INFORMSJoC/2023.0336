...
class Battery(Generator):
    ...
    def store_energy(self, power, duration):
        ...
        battery_level = self._charge_level
    ...
    def _discharge_breakdown(self, energy):
        """Split usable energy and efficiency losses"""
        usable = energy * self._discharge_efficiency
        loss = energy - usable
        return usable, loss
    ...
    def _energy_output(self, duration):
        ...
        energy_output, loss = self._discharge_breakdown(energy)
    ...
    def sizing_max_multiplier(self):
        ...
        return 5.0/(self._charge_efficiency*self._discharge_efficiency)
